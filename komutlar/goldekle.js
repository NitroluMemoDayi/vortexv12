...
exports.run = async (bot, message, args) => {
 ...
 message.client.channels.cache.get('690279835691516019').send(`<a:kirmizi:690267037745807431> \`${nesne}\` ID'li Kullanıcı Gold Üyeliğe Eklendi <a:kirmizi:690267037745807431>`)
