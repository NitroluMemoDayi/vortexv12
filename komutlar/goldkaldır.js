...
exports.run = async (bot, message, args) => {
  ...
  message.client.channels.cache.get('649340846197571584').send(`<a:gri:690267571768786974> \`${nesne}\` ID'li Kullanıcının Gold Üyeliği Silindi <a:gri:690267571768786974>`)
}
exports.conf = {
  enabled: true,
  guildOnly: false,
