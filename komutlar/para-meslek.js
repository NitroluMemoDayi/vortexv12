...
message.channel.send(e2)
    ...
    if (x === 'tamirci') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`${client.emojis.cache.get(client.emojiler.hayır)} Zaten tamirci mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} tamirci olmak için yeterli paran bulunuyor. \n Gerekli olan para: **3000TL**.`)
      } else if  (para > 3000) {
        const madenciE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`${client.emojis.cache.get(client.emojiler.evet)} Yeni mesleğiniz **tamirci**\n${client.emojis.cache.get(client.emojiler.konfeti)} Mesleğinde başarılar.`)
        .setTimestamp()
       message.channel.send(madenciE)
       db.delete(`meslekA_${message.author.id}`)
       db.add(`meslek_${message.author.id}`, 200)
    ...
    if (x === 'emlakçı') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`${client.emojis.cache.get(client.emojiler.hayır)} Zaten emlakçı mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} emlakçı olmak için yeterli paran bulunuyor. \n Gerekli olan para: **5000TL**.`)
      } else if  (para > 5000) {
        const emlakçıE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`${client.emojis.cache.get(client.emojiler.evet)} Yeni mesleğiniz **emlakçı**\n${client.emojis.cache.get(client.emojiler.konfeti)} Mesleğinde başarılar.`)
        .setTimestamp()
    ...
    if (x === 'mimar') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`${client.emojis.cache.get(client.emojiler.hayır)} Zaten mimar mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} mimar olmak için yeterli paran bulunuyor. \n Gerekli olan para: **10000TL**.`)
      } else if  (para > 10000) {
        const mimarE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`${client.emojis.cache.get(client.emojiler.evet)} Yeni mesleğiniz **mimar**\n${client.emojis.cache.get(client.emojiler.konfeti)} Mesleğinde başarılar.`)
        .setTimestamp()
    ...
    if (x === 'doktor') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`${client.emojis.cache.get(client.emojiler.hayır)} Zaten doktor mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} doktor olmak için yeterli paran bulunuyor. \n Gerekli olan para: **20000TL**.`)
      } else if  (para > 20000) {
        const doktorE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`${client.emojis.cache.get(client.emojiler.evet)} Yeni mesleğiniz **doktor**\n${client.emojis.cache.get(client.emojiler.konfeti)} Mesleğinde başarılar.`)
        .setTimestamp()
