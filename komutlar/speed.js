...
exports.run = async (client, message, args) => {
  ...
  var m = await message.channel.send(`${client.emojis.cache.get(client.emojiler.yukleniyor)} Gerekli veriler hesaplanıyor...`)
...
.addField('Pingler', `Discord API Pingi: **${client.ws.ping}**
