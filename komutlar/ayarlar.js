...
exports.run = async (client, message, args) => {
  ...
  var ac = client.emojis.cache.get(client.emojiler.açıkA);
  var ka = client.emojis.cache.get(client.emojiler.kapalıA);
...
${y}**Mod \ Log ${dil.ayarlar.errors.channel}** ${db.has(`log_${message.guild.id}`) ? ac + message.guild.channels.cache.get(db.fetch(`log_${message.guild.id}`)) : `${ka} ${dil.ayarlar.errors.notset} **${prefix}log-ayarla**`}
${y}**Resimli Giriş-Çıkış ${dil.ayarlar.errors.channel}** ${db.has(`gcc_${message.guild.id}`) ? ac + message.guild.channels.cache.get(db.fetch(`gcc_${message.guild.id}`)) : `${ka} ${dil.ayarlar.errors.notset} **${prefix}resim-kanal #kanal**`}  
${y}**Güvenlik ${dil.ayarlar.errors.channel}** ${db.has(`guvenlik3_${message.guild.id}`) ? ac + message.guild.channels.cache.get(db.fetch(`guvenlik3_${message.guild.id}`)) : `${ka} ${dil.ayarlar.errors.notset} **${prefix}güvenlik #kanal**`} 
${y}**Komut ${dil.ayarlar.errors.channel}** ${db.has(`ktr_${message.guild.id}`) ? ac + message.guild.channels.cache.get(db.fetch(`ktr_${message.guild.id}`)) : `${ka} ${dil.ayarlar.errors.notset} **${prefix}komut-kanal #kanal**`}  
...
${y}**Otorol Kayıt ${dil.ayarlar.errors.channel}** ${db.has(`otoRK_${message.guild.id}`) ? `${ac} \`${message.guild.channels.cache.get(db.fetch(`otoRK_${message.guild.id}`)).name}\`` : `${ka} ${dil.ayarlar.errors.notset} **${prefix}oto-rol-kanal**`}
${y}**Sayaç ${dil.ayarlar.errors.channel}** ${db.has(`sKanal_${message.guild.id}`) ? `${ac} ${message.guild.channels.cache.get(db.fetch(`sKanal_${message.guild.id}`)).name}`: `${ka} ${dil.ayarlar.errors.notset} **${prefix}sayaç-kanal-ayarla** `}
...
${y}**Otomatig tag ${dil.ayarlar.errors.channel}** ${db.has(`tagKanal_${message.guild.id}`) ? ac + message.guild.channels.cache.get(db.fetch(`tagKanal_${message.guild.id}`)).name : `${ka} ${dil.ayarlar.errors.notset} **${prefix}tag-kanal-ayarla**`}
${y}**Giriş Çıkış ${dil.ayarlar.errors.channel}** ${db.has(`gc_${message.guild.id}`) ? `${ac} ${client.channels.cache.get(db.fetch(`gc_${message.guild.id}`))}` : `${ka} ${dil.ayarlar.errors.notset} **${prefix}giriş-çıkış-ayarla** `}
